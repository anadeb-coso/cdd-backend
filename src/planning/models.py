...
class Activity(BaseModel):
    ...
    phase = models.ForeignKey(Phase, null=True, blank=True, on_delete=models.SET_NULL,
                              related_name="planning_activities")
    activity = models.ForeignKey(ProcessActivity, null=True, blank=True, on_delete=models.SET_NULL,
                                 related_name="planning_activities")
    ...
    free_task_title = models.CharField(max_length=255, blank=True, null=True,
                                       verbose_name=_('The title of the free activity done'))
    ...
    facilitator = models.ForeignKey(Facilitator, null=True, blank=True, on_delete=models.SET_NULL,
                                    related_name="planning_activities")
    ...
    total_women_present_over_35 = models.IntegerField(null=True, blank=True,
                                                      verbose_name=_("Total women present over 35"))
    total_people_present_over_35 = models.IntegerField(null=True, blank=True,
                                                       verbose_name=_("Total people present over 35"))
    total_men_present_under_35 = models.IntegerField(null=True, blank=True,
                                                     verbose_name=_("Total men present under 35"))
    total_women_present_under_35 = models.IntegerField(null=True, blank=True,
                                                       verbose_name=_("Total women present under 35"))
    total_people_present_under_35 = models.IntegerField(null=True, blank=True,
                                                        verbose_name=_("Total people present under 35"))
    ...
    def get_activities_and_comments(self):
        return sorted((list(self.get_comments()) + list(self.get_activities_validate())),
                      key=lambda obj: obj.created_date, reverse=True)
...
class ActivityValidate(BaseModel):
    ...
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL,
                             related_name="planning_activities_validates")
    facilitator = models.ForeignKey(Facilitator, null=True, blank=True, on_delete=models.SET_NULL,
                                    related_name="planning_activities_validates")
...
class ActivityComment(BaseModel):
    ...
    comment_read = models.BooleanField(default=False)
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL,
                             related_name="planning_activity_comments")
    facilitator = models.ForeignKey(Facilitator, null=True, blank=True, on_delete=models.SET_NULL,
                                    related_name="planning_activity_comments")
