            ...
            return Response(
                {
                    'ok': True,
                    'message': msg,
                    'encoder_email': encoder_email(email)
                }
                , status.HTTP_200_OK
            )
        return Response(
...
class RestChangePassword(APIView):
    def post(self, request, *args, **kwargs):
        ...
        if request.method == 'POST':
            ...
            password_new_confirm = request.data.get('password_new_confirm', None)
            ...
            if email and confirm_code and current_password and password_new and password_new_confirm:
                ...
                if not validation_code:
                    ...
                    msg = _("The confirmation password must be the same as the new password.")
                else:
