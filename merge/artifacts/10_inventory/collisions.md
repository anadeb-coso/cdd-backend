...
- champs seulement COSOMIS : area_status
...
- champs seulement COSOMIS : account_number, bank, bank_code, guichet_code, rib
...
- champs seulement COSOMIS : administrative_level, project
...
| cdd | process_manager.Project | `couch_id` | CharField | True |
| cdd | process_manager.Project | `external_id` | CharField | True |
